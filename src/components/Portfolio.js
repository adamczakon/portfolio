        ...
        <div className='project'>
          <div className='project-description'>
            ...
            <div className='description-grid'>
              <a
                className='btn btn-github'
                href='https://github.com/adamczakon/spaceverse.git'
                target='_blank'
                rel='noopener noreferrer'
              >
                Github
              ...
              <a
                className='btn btn-live'
                href='https://still-brushlands-54388.herokuapp.com/'
                target='_blank'
                rel='noopener noreferrer'
              >
                Live
        ...
        <div className='project last'>
          <div className='project-description'>
            ...
            <div className='description-grid'>
              <a
                className='btn btn-github'
                href='https://github.com/adamczakon/formovie'
                target='_blank'
                rel='noopener noreferrer'
              >
                Github
              ...
              <a
                className='btn btn-live'
                href='https://adamczakon.github.io/formovie/#/'
                target='_blank'
                rel='noopener noreferrer'
              >
                Live
